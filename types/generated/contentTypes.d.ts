...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    PhoneGsm: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFeatureListFeatureList extends Struct.CollectionTypeSchema {
...
export interface ApiFileGalleryFileGallery extends Struct.CollectionTypeSchema {
...
export interface ApiImageGalleryImageGallery
  ...
  attributes: {
    AltTag: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    BottomMenuStatus: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    feature_lists: Schema.Attribute.Relation<
      'oneToMany',
      'api::feature-list.feature-list'
    >;
    file_galleries: Schema.Attribute.Relation<
      'oneToMany',
      'api::file-gallery.file-gallery'
    >;
    Image: Schema.Attribute.Media<'images' | 'files'> &
    ...
    image_galleries: Schema.Attribute.Relation<
      'oneToMany',
      'api::image-gallery.image-gallery'
    >;
    LeftMenuStatus: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    PageContentType: Schema.Attribute.Enumeration<
      [
        'Anasayfa',
        'Blog',
        'Hizmet',
    ...
    TopMenuStatus: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video_galleries: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiWebSiteSettingWebSiteSetting
  ...
  collectionName: 'web_site_settings';
  info: {
    description: '';
    displayName: 'WebSiteSetting';
    pluralName: 'web-site-settings';
    singularName: 'web-site-setting';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::web-site-setting.web-site-setting'
    >;
    ...
    LogoFooter: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::file-gallery.file-gallery': ApiFileGalleryFileGallery;
      ...
      'api::web-site-setting.web-site-setting': ApiWebSiteSettingWebSiteSetting;
